...
public class FarmGame extends JFrame {
	...
	static int money = 100000;	//플레이어 돈
	...
	FarmGame() {
			...
			potionBox.addActionListener(listener);
	...
	potionBox.addActionListener (new ActionListener(){
        public void actionPerformed(ActionEvent ae){
        	...
        	if(hp < 100 && PotionOfHp.count > 0) {
        		System.out.println("사용 전 체력"+hp);
        		System.out.println("사용 전 체력포션 개수"+PotionOfHp.count);
        		hp = hp+10;
        		PotionOfHp.count = PotionOfHp.count-1;
				...
				System.out.println("사용 전 체력포션 개수"+PotionOfHp.count);
				JOptionPane.showMessageDialog(null,"체력이 꽉차서 더이상 사용할 수 없어요!", "SYSTEM", JOptionPane.INFORMATION_MESSAGE);
			}
        	
        	else if(PotionOfHp.count == 0) {
				System.out.println("사용 전 체력포션 개수"+PotionOfHp.count);
