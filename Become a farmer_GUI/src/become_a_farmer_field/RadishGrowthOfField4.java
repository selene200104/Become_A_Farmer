...
public class RadishGrowthOfField4 extends Thread{
	
	static int radishAmount = 0; //수확가능한 무 개수
	
	@Override
	public void run(){
		//System.out.println("무 심기 2번 동작(무 성장 스레드 실행중) 씨앗선택값 : "+Field_4.seedsSelectCount);
		Radish.seedsAmount--;
		...
		try {
	        	...
	        	if(radishAmount == 1) {
	        		Field_4.fieldState++;
	        		System.out.println("식물을 심어서 필드 값 업그레이드 "+Field_4.fieldState);
