...
public class Field_5 extends JFrame {
            	...
            	if(seedsSelectCount == 0) {
            		...
            		if(Lettuce.seedsAmount > 0) {
                		...
                		FarmGame.hp = FarmGame.hp-3;
                   		...
                   		//상추 성장 스레드 시작
                   		LettuceGrowthOfField5 lettuce = new LettuceGrowthOfField5();
                       	lettuce.start();
            ...
            public void actionPerformed(ActionEvent ae){		
            	...
            	if(seedsSelectCount == 0) {
            		...
            		if(Carrot.seedsAmount > 0) {
                		...
                		//당근 성장 스레드 시작
                		CarrotGrowthOfField5 carrotGrow = new CarrotGrowthOfField5();
                		carrotGrow.start();
            ...
            public void actionPerformed(ActionEvent ae){
        		...
        		if(seedsSelectCount == 0) {
        			...
        			if(Radish.seedsAmount > 0) {
        				...
        				//무 성장 스레드 시작
        				RadishGrowthOfField5 radishGrow = new RadishGrowthOfField5();
        				radishGrow.start();
       	...
       	harvest.addActionListener (new ActionListener(){
            public void actionPerformed(ActionEvent ae){
    			...
    			if(fieldState == 2) {
    				...
    				if(LettuceGrowthOfField5.lettuceAmount> 0) {
    					
    					//원래있던 상추 갯수에 수확한 상추 갯수를 추가하고 수확한 값을 0으로 초기화 시킴
            			Lettuce.amount += LettuceGrowthOfField5.lettuceAmount;
            			LettuceGrowthOfField5.lettuceAmount -= LettuceGrowthOfField5.lettuceAmount;
            			System.out.println(LettuceGrowthOfField5.lettuceAmount);
            			...
            			//System.out.println("삭제후 수확 가능한 상추 개수"+LettuceGrowthOfFiled5.lettuceAmount);
    				...
    				if(CarrotGrowthOfField5.carrotAmount> 0) {
                    	
    					//원래 있던 당근 갯수에 수확한 당근 갯수를 추가하고 수확한 값을 0으로 초기화 시킴
            			Carrot.amount += CarrotGrowthOfField5.carrotAmount;
            			CarrotGrowthOfField5.carrotAmount -= CarrotGrowthOfField5.carrotAmount;
            			System.out.println(CarrotGrowthOfField5.carrotAmount);
            			...
            			//System.out.println("삭제후  씨앗 선택 값"+seedsSelectCount);
            			//System.out.println("삭제후 수확 가능한 당근 개수"+CarrotGrowthOfFiled5.carrotAmount);
            			//System.out.println("삭제후 필드 값"+fieldState);
    				...
    				//수확가능한 무 개수가 0개 이상일때
    				if(RadishGrowthOfField5.radishAmount> 0) {
                    	
            			//원래 있던 무 갯수에 수확한 무 갯수를 추가하고 수확한 값을 0으로 초기화 시킴
            			Radish.amount += RadishGrowthOfField5.radishAmount;
            			RadishGrowthOfField5.radishAmount -= RadishGrowthOfField5.radishAmount;
            			System.out.println(RadishGrowthOfField5.radishAmount);
            			...
            			//System.out.println("삭제후  씨앗 선택 값"+seedsSelectCount);
            			//System.out.println("삭제후 수확 가능한 무 개수"+RadishGrowthOfFiled5.radishAmount);
            			//System.out.println("삭제후 필드 값"+fieldState);
