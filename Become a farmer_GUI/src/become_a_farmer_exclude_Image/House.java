...
public class House extends JFrame {
	...
	static int woodHouse_price = 3000;	//나무집 가격
	static int firstFloorHouse_price = 5000;	//1층집 가격
	static int secondFloorHouse_price = 7000;	//2층집 가격
	...
	private class MyListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			//하우스 업그레이드 버튼을 누르면 하우스 업그레이드 스레드 실행
