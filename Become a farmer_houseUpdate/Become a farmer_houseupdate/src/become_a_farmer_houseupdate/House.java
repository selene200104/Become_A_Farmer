...
public class House extends JFrame {
	...
	House() {
		...
		housePanel.setBounds(0, 0, 300, 300);

		JLabel houseNameLabel = new JLabel("현재 당신의 집은  : ");
		houseNameLabel.setBounds(20, 20, 110, 20);
		...
		if (houseGrade == 0) {
			...
			housegrade_container.setBounds(130, 20, 200, 20);
			...
			housegrade_firstFloorHouse.setBounds(130, 20, 200, 20);
			...
			housegrade_secondFloorHouse.setBounds(130, 20, 200, 20);
